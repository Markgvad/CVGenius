...
6. [PROFILE_PICTURE]: If personalInfo.profilePicture exists, use its EXACT value as the src attribute for the profile picture img tag (do not modify the URL in any way), otherwise use a placeholder image or the initials
...
8. [EXPERIENCE]: Generate experience cards with achievements for each job. IMPORTANT: Do not include any icons (no checkmark icons or list style icons) before the achievement titles in the work experience section.
   ...
   - For jobs where collapsible=false, the button should say "Hide details" with up chevron icon
   - For jobs where collapsible=true, the button should say "View details" with down chevron icon
   - The HTML structure must look like this for each job card:
     ...
     - [APPROPRIATE_BUTTON_CONTENT_BASED_ON_COLLAPSIBLE]: Use '<i class="fas fa-chevron-up"></i> Hide details' if collapsible is false, or '<i class="fas fa-chevron-down"></i> View details' if collapsible is true
...
9. [SKILLS]: Generate skill categories with progress bars
   ...
   - Each skill category MUST follow this HTML structure:
     <div class="skill-category [active class only if collapsible=false]">
       ...
       <div class="category-content">
         <!-- Category progress bar is ALWAYS visible -->
         <div class="category-progress-container" style="margin-bottom: 16px;">
   ...
   - The category progress bar must always go first inside category-content
   - Individual skill items should go directly after the progress bar
